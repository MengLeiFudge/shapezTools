...
public class SimpleShape {
    ...
    private HashMap<Operate, ArrayList<SimpleShape>> operateMap = new HashMap<>();


    private ArrayList<SimpleShape> leftCutList = new ArrayList<>();
    //private ArrayList<SimpleShape> leftCutList = new ArrayList<>();
    //private ArrayList<SimpleShape> leftCutList = new ArrayList<>();
    private HashMap<SimpleShape, SimpleShape> stackMap = new HashMap<>();
...
/*    public List<SimpleShape> process(Operate operate, SimpleShape... shape) {
        return switch (operate) {
            case LEFT -> cut(3, 4);
            case RIGHT -> cut(1, 2);
            case TOP_RIGHT -> cut(1);
